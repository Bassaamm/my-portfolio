...
Command: npx gltfjsx@6.5.3 public/models/my-prot-model.glb 
*/
...
export function Model(props) {
  ...
  const { scene, animations } = useGLTF("/models/my-prot-model.glb");
...
useGLTF.preload("/models/my-prot-model.glb");
